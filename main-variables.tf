...
variable "postgres_memory_allocation_mb" {
  type        = "string"
  default     = "3072"
}

variable "postgres_disk_allocation_mb" {
  type        = "string"
  default   = "3072"
}

variable "postgres_admin_pwd" {
  type        = "string"
  description = "Enter the passsword for of the default admin user for the database, usually admin or root (Expected length of password is in range (10 - 32))"
}
